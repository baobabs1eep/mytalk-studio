...
当前版本使用可控的本地演示逻辑验证产品流程与交互。它没有接入真实的大语言模型、TED 内容接口、雅思托福真题服务、语音识别服务、用户账号、数据库或真实社区内容。正式版本可进一步接入 LLM 对话、TED 文本解析、雅思托福题库、词汇语法句式训练、语音识别、表达反馈、账户服务与具备审核机制的社区基础设施。
